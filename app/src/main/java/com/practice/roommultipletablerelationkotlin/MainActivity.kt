package com.practice.roommultipletablerelationkotlin
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            schoolWithDirector.forEach {
                Log.d("MyTag", "schoolWithDirector: ${it.director} ${it.school}")
            }

            val schoolWithStudents = dao.getSchoolWithStudents("Kotlin School")
            schoolWithStudents.forEach {
                Log.d("MyTag", "schoolWithStudents: ${it.school} ${it.students}")
            }
        }
    }
}